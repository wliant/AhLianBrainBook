...
export function TableSection({ section, onUpdate, editing = true }: TableSectionProps) {
              ...
              {headers.map((header, colIdx) => (
                <th key={colIdx} className="border-b border-r last:border-r-0 p-0">
                  {editing ? (
                    ...
                    <span className="block px-2 py-1.5 font-medium text-left">{header}</span>
                  )}
                </th>
              ))}
              {editing && (
                ...
                {row.map((cell, colIdx) => (
                  <td key={colIdx} className="border-b border-r last:border-r-0 p-0">
                    {editing ? (
                      ...
                      <span className="block px-2 py-1.5">{cell}</span>
                    )}
                  </td>
                ))}
                {editing && (
