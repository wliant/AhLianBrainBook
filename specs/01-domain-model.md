...
Per-neuron reminders that trigger notifications. One active reminder per neuron.

| Field              | Type              | Constraints                              | Description                              |
|--------------------|-------------------|------------------------------------------|------------------------------------------|
| id                 | UUID              | PK, auto-generated                       | Unique identifier                        |
| neuronId           | UUID              | NOT NULL, FK -> neurons ON CASCADE, UNIQUE | Parent neuron (one reminder per neuron) |
